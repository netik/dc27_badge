...
int interpret(  )
{
  ...
  //printf("begin interpret(), PC: ");printf(pc,HEX);
   ...
   for ( interpreter_state = RUN; interpreter_state == RUN && halt == FALSE; )
   {
    ...
    //printf(String("read opcode 1: ") + String((int)opcode,HEX));
    //printf("debug 2");
      if ( h_type > V4 && opcode == 0xbe )
      {
         opcode = read_code_byte(  );
         //printf(String("read opcode 2: ") + String((int)opcode,HEX));
         extended = TRUE;
      }
      else
         extended = FALSE;
    ...
    //printf("debug 3");
      ...
      {
         //printf("debug 4: opcode ");printf((int)opcode,HEX);
         ...
         if ( opcode < 0x80 && extended == FALSE )
         {
            ...
            opcode &= 0x1f;
            //printf("debug 4b: opcode ");printf((int)opcode,HEX);
        }
         else
         {
            ...
            opcode &= 0x3f;
            //printf("debug 4c: opcode ");printf((int)opcode,HEX);
...
#endif
            //printf("Debug 5: switch opcode ");printf((int)opcode,HEX);
            switch ( ( char ) opcode )
            {
...
#endif
            //printf("Debug 5b, switch opcode: ");printf((int)opcode,HEX);
            switch ( ( char ) opcode )
            {
      ...
      else
      {
...
#endif
            //printf("Debug 7b: switch opcode "); printf((int)opcode & 0x0f, HEX);
         ...
         else
         {
            ...
            printf(debugbuff);
#endif
            //printf("Debug 8, switch opcode: ");printf((int)opcode & 0x0f,HEX);
            switch ( ( char ) opcode & 0x0f )
            {
               case 0x00:
                  z_ret( TRUE );
