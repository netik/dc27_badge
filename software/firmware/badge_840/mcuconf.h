...
#define NRF5_QSPI_USE_QSPI0		TRUE
#define NRF5_SPI_USE_DMA		TRUE
#define NRF5_SPIM_USE_ANOM58_WAR	FALSE
#define NRF5_SPIM_SLOW_DMA_CHUNK	128
#define NRF5_SPIM_FAST_DMA_CHUNK	1024

#define M25Q_SUPPORTED_MANUFACTURE_IDS	{0xC2}
#define M25Q_SUPPORTED_MEMORY_TYPE_IDS	{0x28}
#define M25Q_SWITCH_WIDTH		FALSE
#define M25Q_USE_SUB_SECTORS		TRUE
