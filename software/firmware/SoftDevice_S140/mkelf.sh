...
# Note: the entry point address 0x999 is the address of the reset
# handler in the SoftDevice module. This address was obtained by
# doing a hex dump of the first few bytes of the object file.

arm-none-eabi-objcopy -I ihex -O binary s140_nrf52_6.1.0_softdevice.hex softdevice.bin
...
arm-none-eabi-objcopy -I elf32-littlearm --add-symbol softdeviceEntry=.softdevice:0x00000999,global,function softdevice.o
