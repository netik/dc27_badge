...
const PALConfig pal_default_config_p1 =
{
  .pads = {
        ...
        PAL_MODE_INPUT_PULLUP,        /* P1.9 : BTN5 (B:up)    */
        PAL_MODE_INPUT_PULLUP,        /* P1.10: BTN6 (B:down)  */
        PAL_MODE_INPUT_PULLUP,        /* P1.11: BTN7 (B:left)  */
        PAL_MODE_INPUT_PULLUP,        /* P1.12: BTN8 (B:right) */
        PAL_MODE_INPUT_PULLUP,        /* P1.13: BTN9 (A:sel)   */
