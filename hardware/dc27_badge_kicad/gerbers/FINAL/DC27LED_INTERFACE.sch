...
U 1 1 5BDAD420
P 2100 1450
F 0 "C301" H 2215 1496 50  0000 L CNN
F 1 "1uF" H 2215 1405 50  0000 L CNN
...
U 1 1 5BDAD49F
P 2700 1450
F 0 "C302" H 2815 1496 50  0000 L CNN
...
U 1 1 5BDADD7C
P 2100 1800
F 0 "#PWR0304" H 2100 1550 50  0001 C CNN
...
U 1 1 5BDADD94
P 2700 1800
F 0 "#PWR0305" H 2700 1550 50  0001 C CNN
...
U 1 1 5BDAF5E8
P 2100 2450
F 0 "C303" H 2215 2496 50  0000 L CNN
F 1 "1uF" H 2215 2405 50  0000 L CNN
...
U 1 1 5BDAF5EE
P 2700 2450
F 0 "C304" H 2815 2496 50  0000 L CNN
...
U 1 1 5BDAF5F9
P 2100 2800
F 0 "#PWR0306" H 2100 2550 50  0001 C CNN
...
U 1 1 5BDAF5FF
P 2700 2800
F 0 "#PWR0307" H 2700 2550 50  0001 C CNN
...
U 1 1 5BDAFD53
P 2100 3450
F 0 "C305" H 2215 3496 50  0000 L CNN
...
U 1 1 5BDAFD59
P 2700 3450
F 0 "C306" H 2815 3496 50  0000 L CNN
...
U 1 1 5BDAFD64
P 2100 3800
F 0 "#PWR0308" H 2100 3550 50  0001 C CNN
...
U 1 1 5BDAFD6A
P 2700 3800
F 0 "#PWR0309" H 2700 3550 50  0001 C CNN
...
U 1 1 5BDB2F4A
P 6050 1150
F 0 "#PWR0303" H 6050 900 50  0001 C CNN
...
U 1 1 5BDB589A
P 7100 4250
F 0 "R302" V 7200 4250 50  0000 C CNN
F 1 "20K" V 7300 4250 50  0000 C CNN
F 2 "Resistor_SMD:R_0805_2012Metric" V 7140 4240 50  0001 C CNN
...
U 1 1 5BDB67EB
P 7450 4300
F 0 "#PWR0310" H 7450 4050 50  0001 C CNN
...
U 1 1 5BDB89D2
P 2100 5500
F 0 "C309" H 2215 5546 50  0000 L CNN
F 1 "1uF" H 2215 5455 50  0000 L CNN
...
U 1 1 5BDB8A02
P 2100 5750
F 0 "#PWR0314" H 2100 5500 50  0001 C CNN
...
U 1 1 5BDBBD80
P 5600 5600
F 0 "#PWR0313" H 5600 5350 50  0001 C CNN
...
U 1 1 5BDBF4DB
P 5100 5150
F 0 "R303" H 5168 5196 50  0000 L CNN
F 1 "10k" H 5168 5105 50  0000 L CNN
...
$Comp
L DC27-badge-cache:+3.3V #PWR0302
U 1 1 5C2B08B8
P 1700 1100
F 0 "#PWR0302" H 1700 950 50  0001 C CNN
...
U 1 1 5C2BE92C
P 6300 1250
F 0 "R301" H 6370 1296 50  0000 L CNN
...
Wire Wire Line
	6300 1400 6300 2100
$Comp
L DC27-badge-cache:+3.3V #PWR0301
U 1 1 5C2C0BF8
P 6300 950
F 0 "#PWR0301" H 6300 800 50  0001 C CNN
...
i2c addr 0xA0 (write) 0xA1 (read)\nchecked all pins 12/29
NoConn ~ 6450 2100
$Comp
L DC27-badge-cache:IS31FL3216A U301
U 1 1 5C3EF393
P 5750 3450
F 0 "U301" H 5750 3650 50  0000 C CNN
F 1 "IS31FL3736-QFLS4-TR" H 5750 3400 50  0000 C CNN
F 2 "Package_DFN_QFN:QFN-40-1EP_5x5mm_P0.4mm_EP3.6x3.6mm" H 5700 1600 50  0001 C CNN
F 3 "" H 4120 4590 50  0001 C CNN
	1    5750 3450
	1    0    0    -1  
$EndComp
Wire Wire Line
